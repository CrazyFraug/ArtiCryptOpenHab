...
Commande cmdos[] = {
  ...
  Commande("lit/switch",        &switchLed1),
  Commande("plafonnier/switch", &switchLed2)
};
...
int switchLed1(const String& sOnOff)
{
    ...
    msg2py = msg2mqttStart + F("lit/etat:") + sValue + msg2pyEnd;
    Serial.print(msg2py);
...
int switchLed2(const String& sOnOff)
{
    ...
    Serial.print(msg2py);
    // I send back state msg
    msg2py = msg2mqttStart + F("plafonnier/etat:") + sValue + msg2pyEnd;
    Serial.print(msg2py);
